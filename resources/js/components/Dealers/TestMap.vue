    ...
    export default {
        ...
        mounted() {
            ...
            ymaps.ready(function () {
                ...
                ymaps.geoQuery(myMap.geoObjects).search('properties.id = 1').setOptions('preset', 'islands#greenIcon');
            });
        },
        watch  : {},
        methods: {
            ...
            test() {
                ymaps.geoQuery(self.myMap.geoObjects).search('properties.id = 0').setOptions('preset', 'islands#violetIcon');
            // console.log(this.map.geoObjects.get(0));
            },
            dealer_enter() {
                // this.map.marker[0].options.set({
                console.log(this.placemarks[0].options.preset);
                this.placemarks[0].options.preset = 'islands#redCircleDotIcon';

                // });
            },
            // providerInfo(ww) {
            //     let self = this;
            //     // console.log(self.placemarks);
            //     // ww.get('target').options.set('preset', 'islands#greenIcon');
            // },
            initMap(ymap) {

                ymap.setBounds(ymap.geoObjects.getBounds());

                console.log(ymap.geoObjects.get(0));
